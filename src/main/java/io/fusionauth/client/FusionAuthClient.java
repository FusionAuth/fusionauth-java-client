...
public class FusionAuthClient {
  ...
  */
   ...
   * 
   * As of version 1.32.2, prefer sending the {{params[0]}} in the request body. To do this, omit the first parameter, and set
   ...
   *
   * @param request The request that contains all of the information about all of the refresh tokens to import.
   * @return The ClientResponse object.
   */
