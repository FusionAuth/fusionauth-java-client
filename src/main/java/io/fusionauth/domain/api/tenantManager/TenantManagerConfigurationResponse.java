...
public class TenantManagerConfigurationResponse {
  ...
  public TenantManagerConfigurationResponse(TenantManagerConfiguration tenantManagerConfiguration) {
    this.tenantManagerConfiguration = tenantManagerConfiguration;
  }
}
