...
public abstract class BaseIdentityProvider<D extends BaseIdentityProviderApplicationConfiguration> extends Enableable  {
  ...
  public IdentityProviderSource source = IdentityProviderSource.System;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), data, applicationConfiguration, debug, id, insertInstant, lambdaConfiguration, lastUpdateInstant, linkingStrategy, name, source, tenantId, tenantConfiguration);
  }
