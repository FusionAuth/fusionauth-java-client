...
public class RefreshTokenRevocationPolicy {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RefreshTokenRevocationPolicy)) {
      return false;
    }
    RefreshTokenRevocationPolicy that = (RefreshTokenRevocationPolicy) o;
    return onLoginPrevented == that.onLoginPrevented &&
           onPasswordChanged == that.onPasswordChanged;
  }

  @Override
  public int hashCode() {
    return Objects.hash(onLoginPrevented, onPasswordChanged);
  }
